...
impl From<&str> for Mreg {
    fn from(s: &str) -> Self {
        match s.to_uppercase().as_str() {
            ...
            "XMM0" | "YMM0" | "X0" => Mreg::X0,
            "XMM1" | "YMM1" | "X1" => Mreg::X1,
            "XMM2" | "YMM2" | "X2" => Mreg::X2,
            "XMM3" | "YMM3" | "X3" => Mreg::X3,
            "XMM4" | "YMM4" | "X4" => Mreg::X4,
            "XMM5" | "YMM5" | "X5" => Mreg::X5,
            "XMM6" | "YMM6" | "X6" => Mreg::X6,
            "XMM7" | "YMM7" | "X7" => Mreg::X7,
            "XMM8" | "YMM8" | "X8" => Mreg::X8,
            "XMM9" | "YMM9" | "X9" => Mreg::X9,
            "XMM10" | "YMM10" | "X10" => Mreg::X10,
            "XMM11" | "YMM11" | "X11" => Mreg::X11,
            "XMM12" | "YMM12" | "X12" => Mreg::X12,
            "XMM13" | "YMM13" | "X13" => Mreg::X13,
            "XMM14" | "YMM14" | "X14" => Mreg::X14,
            "XMM15" | "YMM15" | "X15" => Mreg::X15,
            "FP0" => Mreg::FP0,
            _ => Mreg::Unknown,
        }
    }
